 ...
 * │                                                                          │
 * │ ★★ 그 추첨은 2026-08-08에 껐다 — BOT_SILENCE_CHANCE = 0 이라 **speak=false │
 * │    는 지금 프로덕션에서 오지 않는다.** 아래 분기와 이 문단은 되살릴 때를 위해 │
 * │    남긴다. 이유와 되살리는 조건은 그 상수의 상자에 있다 (요약: 거른 창에서도 │
 * │    대꾸를 열어 둬서, 사람의 패스가 아니라 "주제만 씹는 자리"가 됐다).        │
 * │                                                                          │
