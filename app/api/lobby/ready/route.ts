 ...
 *
 * ★ **이제 시작을 막는다** (2026-08-06 결정). 시작 조건은 사람 2~8명 + 전원 준비이고,
 *   판정은 lib/game/rules.ts 의 startBlock 하나다 — 시작 라우트 둘(/api/room/start ·
 *   /api/room/start-world)과 화면의 시작 버튼이 같은 함수를 본다.
 *
